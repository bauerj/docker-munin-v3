...
# Install munin
RUN cd /tmp && wget https://github.com/munin-monitoring/munin/archive/2.999.3.zip && unzip 2.999.3.zip && cd /tmp/munin-2.999.3 && perl Build.PL && ./Build installdeps && ./Build && ./Build install && cd && rm /tmp/munin-2.999.3 -r
